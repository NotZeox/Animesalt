...
Retrieves streaming links and video sources for an episode.
...
**Note:** This endpoint now returns ALL series by automatically following pagination (up to 50 pages).
...
**Note:** This endpoint now returns ALL movies by automatically following pagination. The response includes a `fetchedPages` field showing how many pages were collected.

**Example Request:**
```
GET https://your-api.com/api/movies
```
